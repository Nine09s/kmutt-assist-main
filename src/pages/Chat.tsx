      ...
      <main className="flex-1 container mx-auto px-4 py-6 flex flex-col h-[calc(100vh-130px)]">
        <div className="max-w-4xl mx-auto w-full flex flex-col h-full relative">
          ...
          <div className="flex justify-between items-center mb-4 shrink-0 px-2">
            ...
            <Button variant="ghost" size="sm" onClick={handleClearChat} className="text-slate-400 hover:text-red-500 hover:bg-red-50" title="ออกจากระบบ / ล้างแชท">
              <Trash2 className="w-4 h-4 mr-1" /> ออกจากระบบ
            </Button>
          </div>
